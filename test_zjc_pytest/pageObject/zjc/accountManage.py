...
class Account(BasePage):
    loc_subaccount_manage=(By.XPATH,"//li[@id='n5-3']")
    loc_add_account=(By.XPATH,"//input[@value='账号']")
    loc_account_type=(By.XPATH,"//i[@state='2']")
    loc_account_confirm=(By.XPATH,"//div[@class='modal-input-div']/input")
    loc_name=(By.ID,"name")
    loc_phone=(By.ID,"phone")
    loc_phone_err=(By.ID,"phoneErr")
    loc_position=(By.ID,"position")
    loc_dept=(By.ID,"dept")
    loc_password=(By.ID,"password")
    loc_confirm_passwd=(By.ID,"confirmP")
    loc_account_auth=(By.XPATH,"//div[@id='authDiv']/i")
    loc_confirm=(By.XPATH,"//input[@value='新增']")
    loc_confirm2=(By.XPATH,"//div[@class='dialog__footer']/a[2]")
    loc_add_auth=(By.XPATH,"//span[@id='noAuth']/a")
    loc_all_project=(By.XPATH,"//li[@id='allProject']/i")
    loc_self_auth=(By.XPATH,"//li[@id='project']//p[@authid='15']")
    loc_other_auth=(By.XPATH,"//li[@authid='18']/i[1]")
    loc_auth_confirm=(By.XPATH,"///input[@value='确定']")
